...
new ScrollMagic.Scene({triggerElement: "#trigger1", triggerHook: 0.5, duration: "80%", offset: "50%"})
            .setTween(runner3)
        ...
        new ScrollMagic.Scene({triggerElement: "#trigger5", triggerHook: 0, duration: "80%"})
            .setTween(runner7)
